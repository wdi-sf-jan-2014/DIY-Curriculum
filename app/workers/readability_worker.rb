class ReadabilityWorker
  ...
  def perform(content_id)
    ...
    # @content.res_title = 
    # @content.res_author = result["author"]
    # @content.res_domain = result["domain"]
    # @content.res_word_count = result["word_count"]
    # @content.res_excerpt = result["excerpt"]
    # @content.res_content = result["content"]
    # @content.save
  end
